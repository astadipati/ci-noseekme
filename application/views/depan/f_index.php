...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url('assets/noseek_template/css/bootstrap.css') ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url('assets/noseek_template/css/custom.min.css') ?>" rel="stylesheet" type="text/css" />
  ...
  <body>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="download">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="../4/cosmo/bootstrap.min.css">bootstrap.min.css</a>
                <a class="dropdown-item" href="../4/cosmo/bootstrap.css">bootstrap.css</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="../4/cosmo/_variables.scss">_variables.scss</a>
                <a class="dropdown-item" href="../4/cosmo/_bootswatch.scss">_bootswatch.scss</a>
              </div>
            </li>
          </ul>
    ...
    <script src="<?php echo base_url('assets/noseek_template/js/jquery.min.js') ?>" type="text/javascript"></script>
    <script src="<?php echo base_url('assets/noseek_template/js/popper.min.js') ?>" type="text/javascript"></script>
